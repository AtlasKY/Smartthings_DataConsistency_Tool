...
class AnalysisDriver 
{
	...
	{
		def project_root = "C:/Users/AtlasKaan/Desktop/EclipseASTWorkspace/TrentCode/src" //REPLACE with your project root
		...
		//LOAD THE DATA TO THE OPAST CLASS
	...
	//	cc.classpath.add(project_root + "/pcompile/grails-bootstrap-3.0.4.jar")
		...
		//TEST FILES FROM TRENT
		File file = new File(project_root + "/co2-vent.groovy")
